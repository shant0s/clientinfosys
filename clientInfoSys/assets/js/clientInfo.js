...
function checkEmail() {
    ...
    if (!check.test(email.value)) {
        document.getElementById('check_email').innerHTML = "Please Enter the valid email id";
        return false;
    }
}
...
function showField(contactType) {
    if (contactType == "Email") {
        document.getElementById('contact_mode').innerHTML = 'Email: <input type="email" name="email" id="email" placeholder="abc@xyz.com" required="required"; "/><div id="check_email"></div>';
